...
set_theme <- function(
    ...
    axis_text_x = ggtext::element_markdown(size = x_text_size, color = y_text_color, family="LM Roman 10"),
    axis_text_y = ggtext::element_markdown(size = y_text_size, color = y_text_color, family="LM Roman 10"),
